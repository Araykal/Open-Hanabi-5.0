...
public class BetterFpsHelper {
    ...
    public static void loadConfig() {
        ...
        if (MCDIR == null) {
            CONFIG_FILE = new File(Hanabi.CLIENT_NAME + "/configs/betterfps.json").getAbsoluteFile();
        } else {
            CONFIG_FILE = new File(MCDIR, Hanabi.CLIENT_NAME + "/configs/betterfps.json").getAbsoluteFile();
        }
