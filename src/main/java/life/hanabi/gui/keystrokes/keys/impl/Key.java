...
public class Key extends AbstractKey {
    ...
    public void renderKey(int x, int y) {
        ...
        if (pressed) {
            ...
            textBrightness = Math.max(0.0D, 1.0D - (double)(System.currentTimeMillis() - this.lastPress) / (((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).fadeTime.getValue().doubleValue() * 5.0D));
        } else {
            ...
            textBrightness = Math.min(1.0D, (double)(System.currentTimeMillis() - this.lastPress) / (((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).fadeTime.getValue().doubleValue() * 5.0D));
        }

        if (((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).keyBackground.getValue()) {
                Gui.drawRect(x + this.xOffset, y + this.yOffset, x + this.xOffset + 22, y + this.yOffset + 22, pressed?((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).backgroundPressedColor.getColor():((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).backgroundColor.getColor());
        }
        ...
        if (((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).arrowKeys.getValue()) {
            double padding = 5.0D;
        ...
        } else if (((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).chroma.getValue()) {
