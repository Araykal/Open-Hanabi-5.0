...
public class SpaceKey extends AbstractKey {
    ...
    public void renderKey(int x, int y) {
        ...
        double fadeTime = (((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).fadeTime.getValue().doubleValue());
        ...
        if ((((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).keyBackground.getValue())) {
            ...
            Gui.drawRect(colorN, xIn, colorN + 70, xIn + 16, pressed?((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).backgroundPressedColor.getColor():((life.hanabi.modules.render.KeyStrokes) Hanabi.INSTANCE.moduleManager.modules.get("KeyStrokes")).backgroundColor.getColor());
        }
