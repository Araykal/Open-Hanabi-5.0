...
public class RoundButton extends Gui {
    ...
    public void drawButton() {
        RenderUtil.drawImageShadow(x, y, x + width, y + height, -1);
        RenderUtil.drawRoundedRectUsingCircle(x, y, x + width, y + height, 2, isFocused ? c1.getRGB() : c2.getRGB());
        Hanabi.INSTANCE.fontLoaders.syFont18.drawCenteredString(string, x + width / 2, y + height / 2 - Hanabi.INSTANCE.fontLoaders.arial18.getHeight() / 2.0f, isFocused ? Tc1.getRGB() : Tc2.getRGB());
    }
