    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                if (isFocused()) {
                    RenderUtil.drawRoundedRectUsingCircle(this.xPosition, this.yPosition, this.xPosition + width, this.yPosition + height, 2, new Color(200, 200, 200).getRGB());
                } else {
                    RenderUtil.drawRoundedRectUsingCircle(this.xPosition, this.yPosition, this.xPosition + width, this.yPosition + height, 2, new Color(220, 220, 220).getRGB());
                }
