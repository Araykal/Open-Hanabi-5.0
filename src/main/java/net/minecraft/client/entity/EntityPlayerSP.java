...
import life.hanabi.event.events.impl.vac.EventDamage;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        EventMotion eventMotion = new EventMotion(EventType.PRE, this.posX, this.posY, this.posZ, this.onGround, this.rotationYaw, this.rotationPitch, this.lastReportedYaw, this.lastReportedPitch);
...
//            renderYawOffset = eventUpdatePre.getYaw();
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            if (this.ridingEntity == null) {
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D,
                        this.motionZ, this.rotationYaw, this.rotationPitch, eventMotion.isOnGround()));
                flag2 = false;
            }
        ...
        EventMotion eventMotionPost = new EventMotion(EventType.POST, this.posX, this.posY, this.posZ, this.onGround, this.rotationYaw, this.rotationPitch, this.lastReportedYaw, this.lastReportedPitch);
        EventManager.call(eventMotionPost);
    }
    ...
    {
        EventChat eventChat = new EventChat(new ChatComponentText(message), EventChat.Type.SEND);
...
//        message = eventChat.getChatMessage();
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !eventNoSlow.isCancelled())
        {
