...
import life.hanabi.modules.misc.AutoGG;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleTitle(S45PacketTitle packetIn) {
        ...
        if (Objects.equals(s, "\2476\247lVICTORY!\247r") ||
                ...
                Objects.equals(s, "\247c\247\u6e38\u620f\u7ed3\u675f\247r") ||
            ...
            ((AutoGG) ModuleManager.modules.get("AutoGG")).sendGG();
        }
    ...
    private boolean validateResourcePackUrl(NetHandlerPlayClient client, String url, String hash) {
        try {
            ...
            if (isLevelProtocol && (url.contains("..") || !url.endsWith("/resources.zip"))) {
                ...
                if (player != null) {
                    PlayerUtil.tellPlayerWithPrefix(I18NUtils.getString("security.resource"));
                }
