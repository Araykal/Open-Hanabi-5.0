...
public class GuiChat extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            IChatComponent ichatcomponent = this.mc.ingameGUI.getChatGUI().getChatComponent(Mouse.getX(), Mouse.getY() + ((mc.currentScreen instanceof GuiChat) ? 14 : 0));
...
//        Hanabi.INSTANCE.guiCustom.drawScreen(mouseX, mouseY);
        ...
        if (ichatcomponent != null && ichatcomponent.getChatStyle().getChatHoverEvent() != null) {
            this.handleComponentHover(ichatcomponent, mouseX, mouseY + ((mc.currentScreen instanceof GuiChat) ? 14 : 0));
        }
