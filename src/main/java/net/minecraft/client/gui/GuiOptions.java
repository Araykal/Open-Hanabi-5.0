...
import life.hanabi.gui.impl.GuiSettings;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(120, this.width / 2 + 5, this.height / 6 + 18, 150, 20, "BetterFPS Options"));
        this.buttonList.add(new GuiButton(114, this.width / 2 - 155, this.height / 6 + 18, 150, 20, "Client Config"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146442_a, this.width / 2, 15, -1);
