...
import life.hanabi.modules.render.Crosshair;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Hanabi.INSTANCE.guiCustom.drawScreen(Mouse.getEventX() / 2, sr.getScaledHeight() - Mouse.getEventY() / 2);
        ...
        if (this.showCrosshair()) {
            ...
            if (Hanabi.INSTANCE.moduleManager.modules.get("Crosshair").stage) {
                Crosshair.Companion.render();
            } else {
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (l1 > 8) {
                ...
                if (this.recordIsPlaying) {
                    l = MathHelper.hsvToRGB(f2 / 50.0F, 0.7F, 0.6F) & -1;
                }
        ...
        if (this.titlesTimer > 0) {
            ...
            if (i2 > 8) {
                ...
                GlStateManager.pushMatrix();
                Hanabi.INSTANCE.fontLoaders.syFont72.drawStringWithShadow(this.displayedTitle, (float) (-Hanabi.INSTANCE.fontLoaders.syFont72.getStringWidth(this.displayedTitle) / 2), -15.0F, -1 | j2);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                Hanabi.INSTANCE.fontLoaders.syFont36.drawStringWithShadow(this.displayedSubTitle, (float) (-Hanabi.INSTANCE.fontLoaders.syFont36.getStringWidth(this.displayedSubTitle) / 2), 8.0F, -1 | j2);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            float f = this.zLevel;
            this.zLevel = -90.0F;
            this.drawTexturedModalRect(i - 91, sr.getScaledHeight() - 22 - posY, 0, 0, 182, 22);
            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1 - posY, 0, 22, 24, 22);
            this.zLevel = f;
            ...
            for (int j = 0; j < 9; ++j) {
                ...
                int l = sr.getScaledHeight() - 16 - 3 - posY;
    ...
    public void renderHorseJumpBar(ScaledResolution scaledRes, int x) {
        ...
        int k = scaledRes.getScaledHeight() - 32 + 3 - posY;
    ...
    public void renderExpBar(ScaledResolution scaledRes, int x) {
        ...
        if (i > 0) {
            ...
            int l = scaledRes.getScaledHeight() - 32 + 3 - posY;
    ...
    public void renderSelectedItem(ScaledResolution scaledRes) {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
            ...
            if (k > 0) {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.getFontRenderer().drawStringWithShadow(s, (float) i, (float) j, -1 + (k << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    public void renderDemo(ScaledResolution scaledRes) {
        ...
        this.getFontRenderer().drawStringWithShadow(s, (float) (scaledRes.getScaledWidth() - i - 10), 5.0F, -1);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            this.getFontRenderer().drawStringWithShadow(s, (float) (i / 2 - this.getFontRenderer().getStringWidth(s) / 2), (float) (i1 - 10), -1);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
