...
public class GuiFlatPresets extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.presetsTitle, this.width / 2, 8, -1);
        this.drawString(this.fontRendererObj, this.presetsShare, 50, 30, new Color(100, 100, 100).getRGB());
        this.drawString(this.fontRendererObj, this.field_146436_r, 50, 70, new Color(100, 100, 100).getRGB());
    ...
    class ListSlot extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiFlatPresets.this.fontRendererObj.drawString(guiflatpresets$layeritem.field_148232_b, p_180791_2_ + 18 + 5, p_180791_3_ + 6, -1);
        }
    }
}
