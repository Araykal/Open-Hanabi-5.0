...
import life.hanabi.modules.render.Nametags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void renderName(T entity, double x, double y, double z) {
        ...
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, entity, this, x, y, z) || (Nametags.TOGGLE && !entity.isInvisible())) {
...
//                        }
    ...
    protected boolean canRenderName(T entity) {
        ...
        return Minecraft.isGuiEnabled() && (entity != this.renderManager.livingPlayer || (Nametags.TOGGLE && entity == Minecraft.getMinecraft().thePlayer)) && !entity.isInvisibleToPlayer(entityplayersp) && entity.riddenByEntity == null;
    }
