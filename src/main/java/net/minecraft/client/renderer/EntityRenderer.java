...
import life.hanabi.modules.combat.Reach;
...
import life.hanabi.modules.pvp.SnapLook;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (Hanabi.INSTANCE.moduleManager.modules.get("Reach").stage ? Reach.Companion.getReach() : 3.0)) {
                this.pointedEntity = null;
...
//                GlStateManager.rotate(entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks, -1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(
                        SnapLook.Companion.getCameraPrevYaw()
                                + (SnapLook.Companion.getCameraYaw() - SnapLook.Companion.getCameraPrevYaw()) * partialTicks + 180.0F,
                        0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(
                        SnapLook.Companion.getCameraPrevPitch()
                                + (SnapLook.Companion.getCameraPitch() - SnapLook.Companion.getCameraPrevPitch()) * partialTicks,
                        -1.0F, 0.0F, 0.0F);
            }
...
//                float f2 = entity.rotationPitch;
                float f1 = SnapLook.Companion.getCameraYaw();
                float f2 = SnapLook.Companion.getCameraPitch();
                ...
                GlStateManager.rotate(SnapLook.Companion.getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(SnapLook.Companion.getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
//                GlStateManager.rotate(entity.rotationPitch - f2, 1.0F, 0.0F, 0.0F);
//                GlStateManager.rotate(entity.rotationYaw - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
//                GlStateManager.rotate(f1 - entity.rotationYaw, 0.0F, 1.0F, 0.0F);
//                GlStateManager.rotate(f2 - entity.rotationPitch, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(f1 - SnapLook.Companion.getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - SnapLook.Companion.getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        } else {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                float f6 = SnapLook.Companion.getCameraPrevYaw()
                        + (SnapLook.Companion.getCameraYaw() - SnapLook.Companion.getCameraPrevYaw()) * partialTicks + 180.0F;
                float f7 = SnapLook.Companion.getCameraPrevPitch()
                        + (SnapLook.Companion.getCameraPitch() - SnapLook.Companion.getCameraPrevPitch()) * partialTicks;
...
//                GlStateManager.rotate(entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * partialTicks + 180.0F, 0.0F, 1.0F, 0.0F);
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (!flag && this.mc.gameSettings.pauseOnLostFocus && (!this.mc.gameSettings.touchscreen || !Mouse.isButtonDown(1))) {
            if (Minecraft.getSystemTime() - this.prevFrameTime > 160L) {
        ...
        if (flag && SnapLook.Companion.overrideMouse()) {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        if (!this.debugView) {
            ...
            if (this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag1 && !Hanabi.INSTANCE.moduleManager.modules.get("BlockOverlay").stage) {
        ...
        if (flag1 && this.mc.objectMouseOver != null && !entity.isInsideOfMaterial(Material.water)) {
            ...
            GlStateManager.disableAlpha();
            this.mc.mcProfiler.endStartSection("outline");
            if (!Hanabi.INSTANCE.moduleManager.modules.get("BlockOverlay").stage) {
