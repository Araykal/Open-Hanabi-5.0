...
import life.hanabi.utils.chunkanimator.lumien.chunkanimator.handler.AsmHandler;
        ...
        if (!this.isChunkRegionEmpty(blockpos))
        {
            ...
            for (Object e : BlockPosM.getAllInBoxMutable(blockpos, blockpos1))
            {
                ...
                else
                {
                    ...
                    if(Xray.contains(new BlockPos(blockposm.getX(), blockposm.getY(), blockposm.getZ()))) {
                        aenumworldblocklayer[0] = EnumWorldBlockLayer.SOLID;
                    }else {
