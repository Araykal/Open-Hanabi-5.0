...
import life.hanabi.event.events.impl.client.EventMouse;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.drawSplashScreen(1, 6, "Textures");
        this.textureMapBlocks = new TextureMap("textures");
        this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
        this.drawSplashScreen(2, 6, "Font");
        Hanabi.INSTANCE.initClient();
//        this.fontRendererObj = FpsMaster.INSTANCE.fontLoaders.msFont18;
        FontManager.init();
        this.fontRendererObj = FontManager.getCurrentFont();
        this.drawSplashScreen(3, 6, "RenderEngine");
        this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
        this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        this.drawSplashScreen(4, 6, "Resources");
        ...
        this.drawSplashScreen(5, 6, "Misc");
        this.renderGlobal = new RenderGlobal(this);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        this.drawSplashScreen(5, 6, "Begining");
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
        this.effectRenderer = new EffectRenderer(this.theWorld, this.renderEngine);
        this.checkGLError("Post startup");
        this.ingameGUI = new GuiIngame(this);
        this.drawSplashScreen(6, 6, "Begining");
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Hanabi.CLIENT_NAME + " " + Hanabi.VERSION + Hanabi.INSTANCE.DESCRIPTION);
    ...
    private void drawSplashScreen(int stage, int totalStage, String arg) {
        ...
        RenderUtil.drawRoundedRectUsingCircle(sr.getScaledWidth() / 2 - 50, sr.getScaledHeight() - 100, sr.getScaledWidth() / 2 - 50 + 100 * (stage / totalStage), sr.getScaledHeight() - 96, 1, new Color(190, 190, 190).getRGB());
        RenderUtil.drawMCImage(sr.getScaledWidth() / 2f - 50, 60, 100, 37, new ResourceLocation("client/logo1.png"));
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (i1 <= 200L) {
                    ...
                    if (Mouse.getEventButtonState() && Mouse.getEventButton() == this.gameSettings.keyBindAttack.getKeyCode() + 100) {
                        Utils.cpsUtil.update(0);
                        //FpsMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK);
                    }
                    if (Mouse.getEventButtonState() && Mouse.getEventButton() == this.gameSettings.keyBindUseItem.getKeyCode() + 100) {
                        Utils.cpsUtil.update(1);
                    }
                    EventManager.call(new EventMouseInput());
                }
            }
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                //    switch (this.objectMouseOver.typeOfHit) {
                //        case ENTITY:
                //            FpsMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK, this.objectMouseOver.typeOfHit, this.objectMouseOver.entityHit, this.objectMouseOver.hitVec);
                //            break;
                //        case BLOCK:
                //            BlockPos blockpos = this.objectMouseOver.getBlockPos();
                //            if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air) {
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
        this.loadWorld(null);
        if (!(MemoryManager.fastLoad.getValue() && Hanabi.INSTANCE.moduleManager.modules.get("MemoryManager").stage)) {
            System.gc();
        }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        EventManager.call(new EventLoadWorld());
