...
import life.hanabi.modules.render.Xray;
...
public class Block {
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
        ...
        int i = worldIn.getCombinedLight(pos, Hanabi.INSTANCE.moduleManager.modules.get("Xray").stage ? 10000 : block.getLightValue());
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        if(ModuleManager.modules.get("Xray").stage) {
            BlockPos posz = pos;
            ...
            if ((this instanceof BlockOre) && Xray.contains(posz)) {
                return true;
            }
        }
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        if (Hanabi.INSTANCE.moduleManager.modules.get("Xray").stage) {
//            if (Xray.contains(Xray.contains(pos))) {
...
//            }
    ...
    public float getAmbientOcclusionLightValue() {
        return Hanabi.INSTANCE.moduleManager.modules.get("Xray").stage ? 1F : (this.isBlockNormalCube() ? 0.2F : 1.0F);
    }
