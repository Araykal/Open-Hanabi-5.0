...
public abstract class Entity implements ICommandSender
{
    ...
    public static void onMove(Entity entity, double x, double y, double z) {
        ...
        if (flag) {
            ...
            for (d6 = 0.05D; x != 0.0D && entity.worldObj.getCollidingBoundingBoxes(entity, entity.getEntityBoundingBox().offset(x, -1.0D, 0.0D)).isEmpty(); d3 = x) {
                if (x < d6 && x >= -d6) {
                    x = 0.0D;
                } else if (x > 0.0D) {
                    x -= d6;
        ...
        if (entity.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
            ...
            AxisAlignedBB axisalignedbb14 = entity.getEntityBoundingBox();
            double d17 = y;
            ...
            if (d20 > d10) {
                ...
                z = d19;
                y = -d17;
                entity.setEntityBoundingBox(axisalignedbb14);
            }
        ...
        if (entity.canTriggerWalking() && !flag && entity.ridingEntity == null) {
            ...
            if (entity.distanceWalkedOnStepModified > (float) entity.nextStepDistance && block1.getMaterial() != Material.air) {
                ...
                entity.playStepSound(blockpos, block1);
            }
        }
